...
1-of-10 inverting decoder/demultiplexer.
          ...
          +---+--+---+             +---+---+---+---*---+---+---+---+
  0   /Y0 |1  +--+ 16| VCC         | S3| S2| S1| S0|/Y0|/Y1|...|/Y9|
  1   /Y1 |2       15| S0    A     +===+===+===+===*===+===+===+===+
  2   /Y2 |3       14| S1    B     | 0 | 0 | 0 | 0 | 0 | 1 | 1 | 1 |
  3   /Y3 |4       13| S2    C     | 0 | 0 | 0 | 1 | 1 | 0 | 1 | 1 |
  4   /Y4 |5  7442 12| S3    D     | . | . | . | . | 1 | 1 | . | 1 |
  5   /Y5 |6       11| /Y9         | 1 | 0 | 0 | 1 | 1 | 1 | 1 | 0 |
  6   /Y6 |7       10| /Y8         | 1 | 0 | 1 | X | 1 | 1 | 1 | 1 |
